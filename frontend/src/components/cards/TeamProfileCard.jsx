...
const TeamProfileCard = ({ teamData, selectedSeason, ratingLabel, ratingValueDisplay }) => {
  return (
    <section className={`${layoutCardClass} overflow-hidden`}>
      <div className="relative flex flex-col gap-8 px-3 py-4 sm:px-8 lg:flex-row lg:items-center">
        ...
        <div className="relative z-10 flex justify-center lg:justify-end">
          <div className="absolute inset-0 -top-6 h-full w-full rounded-3xl bg-gradient-to-tr from-orange-500/30 to-amber-400/20 blur-3xl" />
